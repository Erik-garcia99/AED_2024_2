...
int main(void)
{
    ...
    do
    {
        ...
        printf("5) recorrido postOrden (D I R)\n");
        scanf("%d", &opc);
...
void postOrden(struct Arbol *raiz, struct Arbol *respaldo)
{
    ...
    if (respaldo_aux->procesado == 0)
    {
        ...
        else if (aux->drch != NULL && aux->izq != NULL && aux->izq->procesado == 1 && aux->drch->procesado == 1)
        {
            if (aux->ya_impreso == 0)
            {
                printf("%d - ", aux->numero);
        ...
        else if (aux->izq != NULL && aux->izq->procesado == 1 && aux->drch == NULL)
        {
            if (aux->ya_impreso == 0)
            {
                printf("%d -", aux->numero);
